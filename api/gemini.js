...
const OPENROUTER_APP_NAME = process.env.EXPO_PUBLIC_OPENROUTER_APP_NAME || 'SoniyaAgenticAI';
...
const SYSTEM_PROMPT = [
  ...
  'Privacy rule: never ask to send personal message content to external AI providers, and never claim private message data should leave the device.',
