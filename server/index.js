...
const OPENROUTER_APP_NAME = process.env.OPENROUTER_APP_NAME || 'SoniyaAgenticAIProxy';
...
app.listen(PORT, () => {
  console.log(`Soniya Agentic AI secure proxy running on http://localhost:${PORT}`);
});
